    ...
    <section id="news" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {news.map((item) => (
            <div key={item.id} className="group flex flex-col h-full bg-white rounded-2xl border border-gray-100 hover:border-brand-200 shadow-sm hover:shadow-soft transition-all duration-300">
              ...
              {item.image && (
                <div className="h-52 overflow-hidden rounded-t-2xl relative">
                  ...
                  <div className="absolute top-4 left-4">
                     <span className={`text-xs font-bold px-3 py-1.5 rounded-full shadow-sm backdrop-blur-md border border-white/20 ${
